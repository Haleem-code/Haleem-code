...
I build full-stack web apps and blockchain products. React/Next.js on the frontend, Bun/ElysiaJS on the backend, and on-chain programs on Solana (Anchor, Rust) and EVM (Solidity).

Right now I'm learning **Python for AI/ML**, working through fundamentals (CS50) and building toward backend and AI work in Python.
